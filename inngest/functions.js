...
export const GenerateVideoData = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        const GenerateImagePrompts = await step.run(
            "generateImagePrompt",
            async () => {
                const FINAL_PROPMT = ImagePromptScript.replace('{style}', videoStyle).replace('{script}', script);
                const result = await GenerateImageScript.sendMessage(FINAL_PROPMT)
